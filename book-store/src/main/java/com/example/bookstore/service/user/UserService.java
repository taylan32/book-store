...
public class UserService {
	...
	public UserDto createUser(User user) {
		...
		return UserDto.builder().id(savedUser.getId()).userName(savedUser.getUserName()).email(savedUser.getEmail())
	...
	public User findUserByUserName(String userName) {
		...
		// NotFoundException("Requested user not found"));
	...
	public UserDto findUserInContext() throws Exception {
